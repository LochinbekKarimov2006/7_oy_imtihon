...
function Home() {
  ...
  useEffect(() => {
    api
      .get(`/countries?limit=256&skip=5`)
      .then((response) => {
  ...
  return (
    <div className="px-10">
      <div className="max-w-[1280px] mx-auto div-11 px-5">
        <div>
          <h1 className="text-[36px] div-17 max-w-[70%] font-[600] ">
            Northern Mariana Islands
          </h1>
          <p className="font-[400] div-17 mt-5 max-w-[90%] text-[500]">
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Magni,
            impedit dicta sunt dolorum, quasi facilis necessitatibus nisi quas
            nihil ratione voluptate culpa maiores libero laborum voluptatem,
            harum delectus repudiandae nobis.
          </p>
          <NavLink onClick={() => setData5(e.name.common)} to="/malumod">
            <button className="py-2 px-4 mt-3 bg-[#1405f1] rounded-[10px] text-[#fff]">
              Toliq Malumod
            </button>
          </NavLink>
        </div>
      ...
      <div className="max-w-[1280px] mx-auto mt-[100px] mb-20">
        <div className="flex justify-between items-center border-b-[1px] pb-5">
          <h2 className="text-[25px]">Davlatlar</h2>
          <NavLink to="/davlatlar">
            <img
              className="w-10"
              src="   https://cdn-icons-png.flaticon.com/512/3031/3031735.png "
              alt=""
            />
          </NavLink>
        </div>
        <div className="div-5 mt-10">
          {data.slice(0, 4).map((e, id) => (
            <NavLink
              onClick={() => setData5(e.name.common)}
              to="/malumod"
              key={id}
            >
              <div className=" drop-shadow-md bg-base-100 rounded-[5px]">
                <img
                  className="w-[100%] rounded-t-[5px] img-1"
                  src={e.flags.png}
                  alt={`${e.name.common} flag`}
                />
                <div className="p-[7%] max-w-[100%]">
                  <h2 className="text-2 font-[800]">{e.name.common}</h2>
                  <h2 className="mt-4 text-1  flex">
                    Population:{" "}
                    <p className="font-[400] ml-1">{e.population}</p>
                  </h2>
                  <h2 className="text-1  flex">
                    Region: <p className="font-[400] ml-1">{e.region}</p>
                  </h2>
                  <h2 className="text-1  flex">
                    Capital: <p className="font-[400] ml-1">{e.capital[0]}</p>
                  </h2>
                </div>
              </div>
            </NavLink>
              ...
              <div className="div-8">
                <div className="div-9">
                  <div className="text-[16px] div-17 font-[600]  flex flex-col gap-2">
                    <h2 className="text-[32px] font-[700] mb-3">
                      {data.name.common}
                    </h2>
                    <h3 className="flex">
                      Native Name:{" "}
                      <p className="font-[400]">{data.name.nativeName}</p>
                    </h3>
                    <h3 className="flex">
                      Population:{" "}
                      <p className="font-[400]">{data.population}</p>
                    </h3>
                    <h3 className="flex">
                      Region: <p className="font-[400]">{data.region}</p>
                    </h3>
                    <h3 className="flex">
                      Sub Region: <p className="font-[400]">{data.subregion}</p>
                    </h3>
                    <h3 className="flex">
                      Capital: <p className="font-[400]">{data.capital?.[0]}</p>
                    </h3>
                  </div>
                  <div className="text-[16px] div-17 mt-10  w-[50%] flex flex-col gap-2 font-[600] mb-[-6px]">
                    <h3 className="flex">
                      Top Level Domain: <p className="font-[400]">bo.</p>
                    </h3>
                    <h3 className="flex">
                      Currencies:{" "}
                      <p className="font-[400]">{data.currencies}</p>
                    </h3>
                    <h3 className="flex">
                      Languages: <p className="font-[400]">{data.languages}</p>
                    </h3>
                  </div>
                </div>
              </div>
        ...
        <div className="flex mt-20 justify-between items-center border-b-[1px] pb-5">
          <h2 className="text-[25px]">Davlatlar Rasmlari</h2>
          <NavLink to="/davlatlar">
            <img
              className="w-10"
              src="   https://cdn-icons-png.flaticon.com/512/3031/3031735.png "
