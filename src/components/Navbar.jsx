...
function Navbar() {
    let { data6, setData6 } = useContext(Malumodlar);
    ...
    useEffect(() => {
        ...
        if (data6.length === 0) {
            ...
            console.log("hayirm");
            localStorage.setItem('user', JSON.stringify(data6));
        }
    }, [data6]);
    ...
    return (
        <div className={`drop-shadow-lg bg-base-100 ${theme === 'dark' ? 'dark' : ''}`}>
            <div className="navbar max-w-[1280px] mx-auto h-[80px]">
                <div className="navbar-start">
                    <div className="dropdown ">
                        ...
                        <ul
                            tabIndex={0}
                            className="menu   drop-shadow-md menu-sm dropdown-content bg-base-100 rounded-box mt-3 w-52 p-2 shadow font-[600] text-[16px] text-[#f88204]">
                            <li><NavLink to="/">Home</NavLink></li>
                            <li><NavLink to="/davlatlar">Davlatlar</NavLink></li>
